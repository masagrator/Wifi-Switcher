    ...
    namespace elm {
        ...
        public:
            ...
            virtual void draw(gfx::Renderer *renderer) override {
                ...
                renderer->drawString(Buttons, false, 30, 693, 23, a(tsl::style::color::ColorText));
            ...
            virtual void changeButtons(const char* string) {
                strcpy(Buttons, string);
            }
